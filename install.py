...
if __name__ == '__main__':
    ...
    try:
        ...
        # ===========================================================================
        # --- Git clone/pull krem_plugins
        # ===========================================================================
        # 1- If: krem_plugins folder is in /home/ivan/KremGit/KremSysTest/KremH/krem/krempack/templates/project/library/plugins/ => git pull
        # 2- Else: Git clone krem-plugins to /home/ivan/KremGit/KremSysTest/KremH/krem/krempack/templates/project/library/plugins/

        # 3- copy/replace setup.py to /home/ivan/KremGit/KremSysTest/KremH/krem/krempack/templates/project/library/

        library_path = os.path.join(krem_path, 'krempack', 'templates','project','library')
        plugin_path = os.path.join(library_path, 'plugins')
        krem_plugin_path = os.path.join(plugin_path, 'krem_plugins')
        plugin_repo = 'ssh://git@stash.bitvis.no/bv_krem/krem_plugins.git'

        if not os.path.exists(krem_plugin_path):
            #git clone
            result = subprocess.check_call("git clone " + plugin_repo, shell=True)
        else:
            #git pull
            result = subprocess.call("git pull", shell=True, cwd=krem_plugin_path)
